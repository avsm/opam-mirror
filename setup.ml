...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9d59da77edf558e550ae3501805d9996) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/avsm/opam-mirror";
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lterm-progress-bar", None)
                        ];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "opam_mirror_fetch_urls.ml"
                   });
               Executable
                 ({
                     cs_name = "opam-get-mirror-urls";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "opam_mirror_show_urls.ml"
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¯ÿ\030À\142\151ÊÕäst­\146ÜÞu";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
